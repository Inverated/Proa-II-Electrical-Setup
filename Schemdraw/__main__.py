...
from Array_Creator import ElementArray
...
drawing, (top, bottom) = ElementArray().draw(drawing, elm.Solar, terminateDist=TERMINATING_DISTANCE, series=2, parallel=2, isRight=True)
