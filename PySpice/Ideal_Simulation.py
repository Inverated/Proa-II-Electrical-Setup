...
ESTIMATED_BATTERY_DISCHARGE_POWER = PANEL_ARRAY_TOTAL_POWER - MOTOR_POWER_DEMAND

ESTIMATED_BATTERY_DISCHARGE_CURRENT = ESTIMATED_BATTERY_DISCHARGE_POWER / BATTERY_TOTAL_VOLTAGE
print(ESTIMATED_BATTERY_DISCHARGE_POWER, ESTIMATED_BATTERY_DISCHARGE_CURRENT, BATTERY_MAX_DISCHARGE_CURRENT * BATTERY_IN_PARALLEL)
...
if ESTIMATED_BATTERY_DISCHARGE_POWER < 0 and -ESTIMATED_BATTERY_DISCHARGE_CURRENT > (BATTERY_MAX_DISCHARGE_CURRENT * BATTERY_IN_PARALLEL):
    MOTOR_POWER_DEMAND = PANEL_ARRAY_TOTAL_POWER + (BATTERY_MAX_DISCHARGE_CURRENT * BATTERY_TOTAL_VOLTAGE)
    MOTOR_CURRENT_DEMAND = MOTOR_POWER_DEMAND / MOTOR_VOLTAGE
